...
urlpatterns = [
    ...
    path('<int:project>/<int:equipamento_id>/equipment/config', views.configEquipment_GET, name='configEquipment'),
    path('<int:project>/<int:equipamento_id>/equipment/config/POST', views.configEquipment_POST, name='configEquipmentPost'),
]
